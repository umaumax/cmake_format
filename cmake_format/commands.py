...
def get_fn_spec():
  ...
  fn_spec.add(
      ...
      kwargs={
          "PREFIX": ONE_OR_MORE,
          "TMP_DIR": ONE_OR_MORE,
          "STAMP_DIR": ONE_OR_MORE,
          "LOG_DIR": ONE_OR_MORE,
          "DOWNLOAD_DIR": ONE_OR_MORE,
          ...
          "URL_MD5": ONE_OR_MORE,
          "DOWNLOAD_NAME": ONE_OR_MORE,
          "DOWNLOAD_NO_EXTRACT": ONE_OR_MORE,
          "DOWNLOAD_NO_PROGRESS": ONE_OR_MORE,
          "TIMEOUT": ONE_OR_MORE,
          "HTTP_USERNAME": ONE_OR_MORE,
          "HTTP_PASSWORD": ONE_OR_MORE,
          "HTTP_HEADER": ONE_OR_MORE,
          "TLS_VERIFY": ONE_OR_MORE,
          "TLS_CAINFO": ONE_OR_MORE,
          "NETRC": ONE_OR_MORE,
          "IGNORED": ONE_OR_MORE,
          "OPTIONAL": ONE_OR_MORE,
          "REQUIRED": ONE_OR_MORE,
          "NETRC_FILE": ONE_OR_MORE,
          "GIT_REPOSITORY": ONE_OR_MORE,
          "GIT_TAG": ONE_OR_MORE,
          "GIT_REMOTE_NAME": ONE_OR_MORE,
          "GIT_SUBMODULES": ONE_OR_MORE,
          "GIT_SHALLOW": ONE_OR_MORE,
          "GIT_PROGRESS": ONE_OR_MORE,
          "GIT_CONFIG": ONE_OR_MORE,
          "SVN_REPOSITORY": ONE_OR_MORE,
          "SVN_REVISION": ONE_OR_MORE,
          "SVN_USERNAME": ONE_OR_MORE,
          "SVN_PASSWORD": ONE_OR_MORE,
          "SVN_TRUST_CERT": ONE_OR_MORE,
          "HG_REPOSITORY": ONE_OR_MORE,
          "HG_TAG": ONE_OR_MORE,
          ...
          "CMAKE_GENERATOR_INSTANCE": ONE_OR_MORE,
          "CMAKE_ARGS": ONE_OR_MORE,
          ...
          "LOG_DOWNLOAD": ONE_OR_MORE,
          "LOG_UPDATE": ONE_OR_MORE,
          "LOG_PATCH": ONE_OR_MORE,
          "LOG_CONFIGURE": ONE_OR_MORE,
          "LOG_BUILD": ONE_OR_MORE,
          "LOG_INSTALL": ONE_OR_MORE,
          "LOG_TEST": ONE_OR_MORE,
          "LOG_MERGED_STDOUTERR": ONE_OR_MORE,
          "LOG_OUTPUT_ON_FAILURE": ONE_OR_MORE,
          "USES_TERMINAL_DOWNLOAD": ONE_OR_MORE,
          "USES_TERMINAL_UPDATE": ONE_OR_MORE,
          "USES_TERMINAL_CONFIGURE": ONE_OR_MORE,
          "USES_TERMINAL_BUILD": ONE_OR_MORE,
          "USES_TERMINAL_INSTALL": ONE_OR_MORE,
          "USES_TERMINAL_TEST": ONE_OR_MORE,
          "DEPENDS": ONE_OR_MORE,
          "EXCLUDE_FROM_ALL": ONE_OR_MORE,
          ...
          "DEPENDS": ONE_OR_MORE,
          "BYPRODUCTS": ONE_OR_MORE,
          "ALWAYS": ONE_OR_MORE,
          "EXCLUDE_FROM_MAIN": ONE_OR_MORE,
          "WORKING_DIRECTORY": ONE_OR_MORE,
          "LOG": ONE_OR_MORE,
      })
